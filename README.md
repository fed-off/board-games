...
## Задачи
### Интерфейс
- [x] добавить карточки и кубик в цетре поля #11
- [ ] добавить левую панель с кнопками и иконками
- [ ] дсделать обратную сторону карточек с ценами с отелем, домом и тд

### Логика
- [ ] дсделать возможность перемещать фигурки и домики
- [ ] дсделать чтобы у всех игроков отображалось текущее положение перемещаемых объектов
- [x] добавить логику работы кубика с синхронизацией #12
- [ ] дредактировать поле с балансом и синхронизацию
- [ ] ддобавить видимость курсоров всех игроков с подписью (под вопросом)
- [ ] ддобавить логику отображения карточки шанс
- [ ] ддобавить логику изменения владельца недвижимости и отображения и карточки выхода из тюрьмы
