...
- [x] добавить левую панель с кнопками и иконками
- [x] сделать обратную сторону карточек с ценами с отелем, домом и тд

### Логика
- [x] сделать возможность перемещать фигурки и домики
- [x] сделать чтобы у всех игроков отображалось текущее положение перемещаемых объектов
...
- [x] добавить логику отображения карточки шанс
- [x] добавить логику изменения владельца недвижимости и отображения и карточки выхода из тюрьмы
- [x] добавить логику сброса состояния игры
